...
struct TrackableScrollView<Content>: View where Content: View {
    ...
    init(_ axes: Axis.Set = .vertical, showIndicators: Bool = true, contentOffset: Binding<CGFloat>, calendarViewModel: CalendarViewModel, @ViewBuilder content: () -> Content) {
        self.axes = axes
        self.showIndicators = showIndicators
        self._contentOffset = contentOffset
        self.calendar = calendarViewModel
